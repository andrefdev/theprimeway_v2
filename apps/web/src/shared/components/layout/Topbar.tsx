...
const ROUTE_LABELS: Record<string, string> = {
  ...
  'weekly': 'weekly',
  'all': 'all',
  'backlog': 'crumbBacklog',
  'stats': 'crumbStats',
  'archive': 'crumbArchive',
  'habits': 'navHabits',
  'tracker': 'crumbTracker',
  'list': 'crumbList',
  'goals': 'navGoals',
  'tree': 'crumbTree',
  'journey': 'crumbJourney',
  'metrics': 'crumbMetrics',
  'roadmap': 'crumbRoadmap',
  'quarterly': 'crumbQuarterly',
  'recurring': 'recurring',
  ...
  'brain': 'navBrain',
  'rituals': 'navRituals',
  'daily-plan': 'crumbDailyPlan',
  'daily-shutdown': 'crumbDailyShutdown',
  'weekly-plan': 'crumbWeeklyPlan',
  'weekly-review': 'crumbWeeklyReview',
  'quarterly-review': 'crumbQuarterlyReview',
  'annual-review': 'crumbAnnualReview',
}
