...
import type { useDataGrid, DataGridMeta } from '@/shared/hooks/use-data-grid'
...
export function DataGrid<TData>({
  ...
  const meta = table.options.meta as DataGridMeta<TData> | undefined
  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={0}
        ref={dataGridRef}
        className="relative grid overflow-auto rounded-xl border select-none focus:outline-none"
        style={{
          ...columnSizeVars,
          maxHeight: `${height}px`,
        }}
