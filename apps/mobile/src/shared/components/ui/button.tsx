  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline: cn(
          'border-border/80 bg-card active:bg-muted dark:bg-input/30 dark:border-input dark:active:bg-input/50 border shadow-sm shadow-black/5',
          Platform.select({
      ...
      size: {
        ...
        lg: cn('h-12 rounded-2xl px-6 sm:h-11', Platform.select({ web: 'has-[>svg]:px-4' })),
