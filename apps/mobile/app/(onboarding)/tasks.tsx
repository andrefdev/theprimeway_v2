...
import { ChevronRight, ChevronLeft, CheckSquare, Info } from 'lucide-react-native';
import { useTranslation } from '@/shared/hooks/useTranslation';

const SUGGESTION_KEYS = ['planWeek', 'setupBudget', 'defineGoals', 'organizeWorkspace', 'reviewPriorities', 'scheduleWorkout'] as const;

const TOTAL_STEPS = 5;
const CURRENT_STEP = 3;

export default function TasksScreen() {
  const { t } = useTranslation('features.onboarding.tasksSetup');
